...
public class FeesAdapter extends BaseAdapter {
    ...
    public FeesAdapter(AppCompatActivity act, JSONArray arraylist) {
        this.context = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            SimpleDateFormat formatdmy = new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault());
            Date date = format.parse(jObj.getString("pay_date"));
            txtDate.setText(formatdmy.format(date));
            ...
            txtpayAmountLast.setText(jObj.getString("last_paid_amount"));
