...
public class EventAdapter extends BaseAdapter {
    ...
    public EventAdapter(AppCompatActivity act, JSONArray arraylist) {
        this.context = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            start_date.setText(context.getResources().getString(R.string.from) + jObj.getString("event_start"));
            end_date.setText(context.getResources().getString(R.string.to) + jObj.getString("event_end"));
