...
import com.nexzenstudent.Notification_detailActivity;
...
public class NotificationAdapter extends BaseAdapter {
    ...
    public NotificationAdapter(AppCompatActivity act, JSONArray arraylist) {
        this.context = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if(jObj.getString("noti_image").length() == 0){
                image_url = "";
                ImageLoader.getInstance().displayImage(ConstValue.BASE_URL + "/uploads/profile/" + common.getSession("school_logo"), iv_notific, options, animateFirstListener);
            }else{
                image_url = jObj.getString("noti_image");
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(image_url.length() == 0){
                        detailIntent.putExtra("image_path", "");
                    }else{
...
//        condition based code
        if(image.length() == 0){
            ImageLoader.getInstance().displayImage(ConstValue.BASE_URL + "/uploads/profile/" + common.getSession("school_logo"), iv_image, options, animateFirstListener);
        }else{
            ImageLoader.getInstance().displayImage(ConstValue.IMG_NOTIFICATION_URL + image, iv_image, options, animateFirstListener);
        }
