...
import com.nexzenstudent.ViewBookActivity;
...
public class BookAdapter extends BaseAdapter {
    ...
    public BookAdapter(AppCompatActivity act, JSONArray arraylist) {
        this.context = act;
...
//            txtAuthor.setText(jObj.getString("book_author"));
            ...
            txtDownload.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (file.exists()) {
                        Toast.makeText(context, "This file is already downloaded at" + SDCardRoot + "/Education_PDF/", Toast.LENGTH_SHORT).show();
                    } else {
