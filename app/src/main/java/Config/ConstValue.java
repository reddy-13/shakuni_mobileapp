...
public class ConstValue {
    ...
    public static String BASE_URL = "https://erp.nexzensystem.com" ; /*"https://erp.nexzensystem.com";*/
    // Base_url will connect with your Admin panel to application... this is path of domain where you host your admin panel.
    // If there is extra "/" at end of url sometime api do not work so please remove extra slash.
    ...
    public static String GCM_SENDER_ID = "1033108688409";// "881835876590";

    //Sun,Mon,Tue,Wed,Thu,Fri,Sat
    public static final String HOLIDAY_START_DAY = "Sat";
